...
export const MemberDashboard = () => {
  ...
  const calendarCells = Array.from({ length: firstDayOfWeek }, () => null).concat(
...
const CalendarCell = ({
  ...
  return (
    <div
      ...
      className={`${base} ${statusStyle[record.status]} ${
        isToday ? "ring-2 ring-offset-1 ring-offset-background ring-foreground" : ""
      }`}
    >
      {day}
    </div>
